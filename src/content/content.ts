...
export const content = {
  ...
  gallery: {
    title: "Галерея",
    images: [
      { src: container1, title: "Контейнерная площадка" },
      { src: container2, title: "Депо" },
      { src: container3, title: "Оборудование" },
      { src: container4, title: "Терминал" },
      { src: loader1, title: "Техника" },
      { src: loader2, title: "Перемещение" },
      { src: repairImage, title: "Ремонт" },
      { src: shop1, title: "Цех" },
      { src: before1, title: "До ремонта" },
      { src: after1, title: "После ремонта" },
      { src: before2, title: "До ремонта" },
      { src: after2, title: "После ремонта" },
      { src: before4, title: "До ремонта" },
      { src: after3, title: "После ремонта" },
      { src: after4, title: "После ремонта" },
    ],
  },
  footer: {
    rights:
