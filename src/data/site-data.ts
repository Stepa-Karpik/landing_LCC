...
export const hero = {
  ...
  title: "ЛКК Контейнерный терминал",
  titleLines: ["ЛКК", "Контейнерный", "терминал"],
  lead:
    "Депо, ремонт, склад, перетарка и припортовая логистика для контейнерного оборота, где простой измеряется деньгами.",
  image: container1,
};
